...
| New `src/templates/agents.md` bootstrap template | Follows established template pattern; ensures consumer projects get AGENTS.md via init | [ADR-047](decisions/adr-047-claude-md-bootstrap-template.md) |
