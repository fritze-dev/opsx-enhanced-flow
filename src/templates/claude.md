...
All changes to this project MUST go through the OpenSpec flow (`/opsx:workflow propose`, `/opsx:workflow apply`, etc.). Never edit specs, skills, templates, or docs directly — always create a change first.
...
- **Rules/conventions** → propose a CONSTITUTION.md update via `/opsx:workflow propose`
- **Decisions with rationale** → these emerge naturally as design.md artifacts and ADRs during the change flow
- **Requirements** → propose spec updates via `/opsx:workflow propose`
