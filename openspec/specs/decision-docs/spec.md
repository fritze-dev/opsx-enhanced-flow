...
- **Incremental detection ambiguity**: If the agent cannot determine which changes produced existing ADRs (e.g., no change/archive backlink in older ADR files), it SHALL fall back to full ADR regeneration for that run.
