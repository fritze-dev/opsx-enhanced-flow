...
- **WHEN** the user invokes `workflow apply add-user-auth`
...
- If tasks.md does not exist but the change has artifacts, the system SHALL inform the user and suggest running `workflow propose` to generate tasks first.
