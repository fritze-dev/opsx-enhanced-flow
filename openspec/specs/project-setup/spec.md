...
The merge detection SHALL apply to all Smart Templates including docs templates in subdirectories. WORKFLOW.md and CONSTITUTION.md are excluded from template merge — they use their existing skip-if-exists logic.
